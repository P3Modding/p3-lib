...
use log::debug;
use p3_api::{
    data::{class27::Class27Ptr, ddraw_fill_solid_rect, ddraw_set_constant_color, get_resolution_width},
...
static CALCULATED_RESOLUTION_BEFORE_SCENE_LOAD_CONTINUATION: u32 = 0x00432D58;

// Overwrite calculated results ui options field
const CALCULATE_RESOLUTION_AFTER_SCENE_LOAD_PATCH_ADDRESS: u32 = 0x00463FBB;
static CALCULATED_RESOLUTION_AFTER_SCENE_LOAD_CONTINUATION: u32 = 0x00463FFD;
...
pub unsafe extern "cdecl" fn reposition_ui_elements_top_bar_custom() -> u32 {
    ...
    if real_resolution_width <= 1280 {
        ...
        debug!("Returning 1280 resolution width {}", real_resolution_width);
        1280
    }
}
...
pub unsafe extern "thiscall" fn maybe_render_all_objects_hook(this: u32, a2: u32, a3: u32, a4: u32, a5: u32) -> i32 {
    ...
    ddraw_fill_solid_rect(100, 100, 200, 200);
    0
}
...
continuation = sym CALCULATED_RESOLUTION_BEFORE_SCENE_LOAD_CONTINUATION);
...
continuation = sym CALCULATED_RESOLUTION_AFTER_SCENE_LOAD_CONTINUATION);
